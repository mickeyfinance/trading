...
"""
This script aims to combine Renko chart and MACD to create a alpha generating strategy.
"""
# =============================================================================
...
with open('/Users/mickeylau/Desktop/quantrading/nasdaq_list.csv', 'r', encoding='utf-8-sig') as f:
    reader = csv.reader(f)
    tickers = list(reader)
